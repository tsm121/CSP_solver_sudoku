...
class CSP:
    ...
    def backtrack(self, assignment):
        ...
        for value in assignment[unassigned_var]:
            domain_copy = copy.deepcopy(assignment)
            domain_copy[unassigned_var] = [value]
            queue = self.get_all_arcs()
            self.add_variable(value, domain_copy)

            inference = self.inference(domain_copy, queue)
            if inference:
...
if __name__ == '__main__':
    ...
    for board in boards:
        ...
        csp = create_sudoku_csp("sudokus/" + board)
        print "Board: " + board
        print "------------------------------ "
        print_sudoku_solution(csp.domains)
        print "\nSolution to board " + board + ":"
        print "------------------------------"
        result = csp.backtracking_search()
        print print_sudoku_solution(result) , "\n"
